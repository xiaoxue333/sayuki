/**
 * Sayuki — Runic Capacitor (Curios relic slot item, +3 relic slots when equipped)
 */
...
public class RunicCapacitor extends Item implements ICurioItem {

    private static final UUID SLOT_MODIFIER_UUID = UUID.fromString("a7e8f9d0-1234-4abc-9def-0123456789ab");

    public RunicCapacitor(Properties properties) {
        super(properties);
    }
